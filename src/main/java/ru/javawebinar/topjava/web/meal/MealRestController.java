...
public class MealRestController {
    ...
    public List<MealTo> getFiltered(LocalDate startDate, LocalTime startTime, LocalDate endDate, LocalTime endTime) {
        ...
        return MealsUtil.getFilteredWithExcess(service.getAll(SecurityUtil.authUserId()),
                ...
                LocalDateTime.of(startDate != null ? startDate : LocalDate.MIN, startTime != null ? startTime : LocalTime.MIN),
                LocalDateTime.of(endDate != null ? endDate : LocalDate.MAX, endTime != null ? endTime : LocalTime.MAX));
    }
